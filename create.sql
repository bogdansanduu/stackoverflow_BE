...
create table questions (question_id bigint not null auto_increment, title varchar(255), content_id bigint not null, primary key (question_id)) engine=InnoDB;
...
alter table questions add constraint UK_151qol4qotq09gmn6bd7u2pqa unique (content_id);
